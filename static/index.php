...
<html>
    ...
    <body>
        ...
        <div class="logo"></div>
        <div class="logotext">
            <h2><a href="https://github.com/nextcloud/vm" target="_blank">ownCloud VM</a> - by <a href="https://nextcloud.com" target="_blank">ownCloud Community</a></h2>
        </div>
        <br>
        ...
        <h2><a href="https://www.techandme.se/user-and-password-nextcloud/" target="_blank">Login</a> to ownCloud</h2>
